...
<body>
    ...
    ?>
    <form class="px-[500px] py-4" method="POST" action="xulysuanguoidung.php?customer_id=<?php echo $customer_id; ?>">
        <h1 class="text-center text-3xl fw-bold">Sửa người dùng</h1>
        <div class="mb-6">
